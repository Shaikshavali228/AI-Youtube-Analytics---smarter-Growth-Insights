        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div className="flex justify-center">
            <a className="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-sm text-gray-800 p-1 ps-3 rounded-full transition hover:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700 dark:hover:border-neutral-600 dark:text-neutral-200"
              ...
              🚀 Launch Your Channel with TubePulse AI Toolkit
          ...
          <div className="mt-5 max-w-2xl text-center mx-auto">
            <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
              TubePulse: Smarter
              <span className="bg-clip-text bg-gradient-to-tl from-orange-600 to-orange-600 text-transparent"> YouTube Growth with AI</span>
            </h1>
          </div>
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            <p className="text-lg text-gray-600 dark:text-neutral-400">
              Analyze,Optimize, and Grow Your youtube channel with AI -- all in one platform for Creators.</p>
          </div>


          <div className="mt-8 gap-3 flex justify-center">
            <a className="inline-flex justify-center items-center 
      gap-x-3 text-center bg-gradient-to-tl from-orange-600
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
          ...
          <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-gray-600 dark:text-neutral-400"> Easily create high-converting YouTube thumbnails using AI. Customize colors, fonts, and layout in seconds to match your video style.</p>
              <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-orange-600 decoration-2 group-hover:underline font-medium">
                Learn more
                <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg>
              </span>
            </div>
          ...
          <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-gray-600 dark:text-neutral-400"> Instantly search and compare top-performing thumbnails from trending videos. Get visual insights and boost your click-through rate.</p>
              <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-orange-600 decoration-2 group-hover:underline font-medium">
                Learn more
                <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg>
              </span>
          ...
          <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
            ...
            <div className="mt-5">
              <h3 className="group-hover:text-gray-600 text-lg font-semibold text-gray-800 dark:text-white dark:group-hover:text-gray-400">AI Content Creator</h3>
              <p className="mt-1 text-gray-600 dark:text-neutral-400">Generate video scripts, titles, descriptions, and even shorts with AI tailored for your niche. Say goodbye to content blocks!</p>
              <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-orange-600 decoration-2 group-hover:underline font-medium">
                Learn more
                <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg>
              </span>
          ...
          <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-gray-600 dark:text-neutral-400"> Identify unusual performance patterns or video spikes. Find what’s working (or not) with AI-based video analytics</p>
              <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-orange-600 decoration-2 group-hover:underline font-medium">
                Learn more
                <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg>
              </span>
