...
function VideoOutlierCard({ videoInfo }:props) {
    const onSearchSimilarThumbnail=()=>{
  ...
  return (
    ...
    <div className='p-3 border rounded-2xl cursor-pointer  relative'>
        ...
        <div className='flex justify-between items-center mt-1'>
            <h2 className='flex gap-2 items-centertext-xs text-gray-400'><Eye className='h-4 w-4'/>
                {videoInfo.viewCount}
            </h2>
            ...
            <Tooltip>
            <TooltipTrigger asChild>
                <h2 className='flex gap-2 items-centertext-xs text-white bg-red-500 p-1 rounded-sm'><ThumbsUp className='h-4 w-4'/>
                {videoInfo.engagementRate}
                </h2>
            </TooltipTrigger>
            <TooltipContent>
            <p>Engagement Rate</p>
